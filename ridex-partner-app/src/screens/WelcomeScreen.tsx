      ...
      <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
        ...
        <View style={styles.actions}>
          ...
          <Text style={styles.legal}>
            ...
            <Text style={styles.legalLink} onPress={() => navigation.navigate('Legal', { slug: 'partner-terms' })}>
              Partner Terms
            </Text>{' '}
            &amp;{' '}
            <Text style={styles.legalLink} onPress={() => navigation.navigate('Legal', { slug: 'privacy-policy' })}>
              Privacy Policy
            </Text>
          </Text>
        </View>
